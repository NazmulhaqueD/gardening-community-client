...
const TopTrending = () => {
    ...
    return (
        <div className='bg-base-100 rounded-2xl '>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-4 rounded-2xl'>
                {
                    topTips.map(tips => <div
                        key={tips._id}
                        className='rounded-2xl overflow-hidden transform transition duration-500 hover:-translate-y-4 hover:bg-base-200 shadow-[1px_2px_10px_#22702D] hover:shadow-[2px_5px_20px_#22702D] hover:skew-x-6 hover:scale-95'
                    >
