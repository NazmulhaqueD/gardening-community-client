...
const Banner = () => {
    ...
    return (
        <div className='rounded-2xl my-8 md:my-16'>
            ...
            >
                <SwiperSlide>
                    <div className='bg-[url(https://i.postimg.cc/t4P0y7rx/860.jpg)] bg-cover bg-center h-[60vh] flex justify-center items-center rounded-2xl shadow-2xl'>
                ...
                <SwiperSlide>
                    <div className='bg-[url(https://i.postimg.cc/6pVHYZjY/download-3.jpg)] bg-cover bg-center h-[60vh] flex justify-center items-center rounded-2xl shadow-2xl'>
                        <div className='p-8 text-center space-y-3'>
                            <h1 className='text-white font-bold text-3xl md:text-6xl'>Grow Your Dream Garden</h1>
                            <p className='text-xl text-white'>We help you create a green space that brings peace and joy.</p>
                            <button className='btn btn-primary'>Explore</button>
