            ...
            <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6'>
                {
                    gardeners.map(gardener => <div
                        key={gardener._id}
                        className='flex flex-col justify-center items-center gap-4 py-6 px-12 shadow-lg bg-base-200 rounded-2xl transition duration-300 transform hover:scale-105 hover:shadow-2xl hover:bg-base-300'>
